        ...
        try {
            ...
            return responses.map(res => {
                ...
                const allSpecs = [
                    ...
                    { label: "Immersionlength", value: data.immersionlength },
                    { label: "Installation", value: data.installation },
                    { label: "Drive", value: data.drive },
                    { label: "Rotationspeedcontrol", value: data.rotationspeedcontrol },
                    { label: "propellertype", value: data.propellertype },
                    { label: "OperatingTemperature", value: data.operatingTemperature },
                    { label: "Viscosity", value: data.viscosity },
                    { label: "Operation", value: data.operation },
                    { label: "Bucket Construction", value: data.bucketConstruction },
                    { label: "Frame / Structure", value: data.frameStructure },
                    { label: "Kettle Depth Capability", value: data.kettleDepthCapability },
                    { label: "Scoop Capacity", value: data.scoopCapacity },
                    { label: "Lift Arrangement", value: data.liftArrangement },
